...
class Objet extends Model {
	...
	public $table = 'objet'; //  Spécifie le nom de la table (par défaut un 's' est ajouté sinon et ça fout la merde) !
    ...
    protected $fillable = ['idObjet', 'nom', 'quantite', 'idCategorie'];
