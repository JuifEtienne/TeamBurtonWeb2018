...
class Journey extends Model {
	...
	public $table = 'journey'; // Spécifie le nom de la table (par défaut un 's' est ajouté sinon et ça fout la merde) !
    ...
    protected $fillable = ['id', 'name', 'startingDate', 'endingDate'];
